...
fn sampleObject(input2: vec2f) -> vec3f {
	...
	var ref_2f0f9 = instanceId % ref_46672;
	var ref_336ac = ref_2f0f9 * columnSpacing;
	var ref_97b72 = ref_714b0 * columnSpacing;
	var ref_5bf06 = ref_336ac + ref_97b72;
	var ref_2056a = instanceId / ref_46672;
	var ref_0f40e = ref_2056a * columnSpacing;
	var ref_dd71c = 3 - ref_0f40e;
	var ref_ff4c1 = vec2f(ref_d8db2, ref_e2e36);
	var ref_4530f = input2 * ref_ff4c1;
	var ref_91c3c = Cylinder(ref_4530f);
	...
	var ref_48300 = cos(1 * ref_bfa54 + 0);
	...
	var ref_2ccbe = cos(1 * ref_3a454 + 0);
	var ref_262db = ref_2ccbe * ref_1f326;
	var ref_7413e = sin(1 * ref_3a454 + 0);
