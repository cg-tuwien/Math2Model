...
fn sampleObject(input2: vec2f) -> vec3f {
	...
	var HALF_PI = 3.14159265359 / 2.0;
	var TWO_PI = 3.14159265359 * 2.0;
	var ref_d7fd6 = Sphere(input2);
	var ref_ac269 = sign(sin(ref_d7fd6*1.00000000000000000000));
	var ref_292d2_1 = ref_ac269[0];
	var ref_292d2_2 = ref_ac269[1];
	var ref_292d2_3 = ref_ac269[2];
	var instanceId = f32(instance_id);
	var spacing = 3.50000000000000000000;
	var ref_b7cb1 = HALF_PI * 0.5;
	var ref_a9814 = ref_b7cb1 * instanceId;
	var ref_f0b06 = sin(1.00000000000000000000 * ref_a9814 + 0.00000000000000000000);
	var ref_c734c = cos(1.00000000000000000000 * ref_a9814 + 0.00000000000000000000);
	var ref_e8526 = ref_292d2_1 + ref_c734c;
	var ref_5dd60 = ref_f0b06 + ref_292d2_3;
	var ref_d2d93 = ref_c734c * spacing;
	var ref_f4879 = spacing * ref_f0b06;
	var ref_d2635 = ref_e8526 + ref_d2d93;
	var ref_3fd28 = ref_5dd60 + ref_f4879;
	var ref_c982c = vec3f(ref_d2635, ref_292d2_2, ref_3fd28);
	var ref_bed5b = mat3x3(vec3f(1.00000000000000000000,0.0,0.0), vec3f(0.0,1.89999999999999991118,0.0), vec3f(0.0,0.0,1.00000000000000000000)) * ref_c982c;
	return ref_bed5b;
