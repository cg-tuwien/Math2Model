...
fn sampleObject(input2: vec2f) -> vec3f {
	...
	var HALF_PI = 3.14159265359 / 2.0;
	var TWO_PI = 3.14159265359 * 2.0;
	var ref_5465b = Sphere(input2);
	var ref_75e78 = sign(sin(ref_5465b*1.00000000000000000000));
	...
	var ref_9bf38 = vec3f(ref_1c3cd_1, ref_330f3_2, ref_1c3cd_3);
	var ref_4da81 = mat3x3(vec3f(2.00000000000000000000,0.0,0.0), vec3f(0.0,1.00000000000000000000,0.0), vec3f(0.0,0.0,2.00000000000000000000)) * ref_9bf38;
	return ref_4da81;
